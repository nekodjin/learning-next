import { SocialIconProps, socialIcon } from "@/lib/social_icon";

/**
 * The LinkedIn icon from the CoreUI Brands icon pack.
 * https://icones.js.org/collection/cib
 */
export default function LinkedinIcon(props?: SocialIconProps) {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 32 32"
            className={socialIcon(props)}
        >
            <path
                fill="currentColor"
